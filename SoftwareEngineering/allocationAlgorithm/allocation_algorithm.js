...
con.query("DELETE FROM FinalAllocation;",function(err0,result0){ // deleting the table finalallocation and starting the allocation afresh
  if(err0) throw err0;
    ...
    if (err1) throw err1;
      ...
      for(course in final_allocation_of_course)
      {
        ...
        console.log("The TA allocations were succesfully inserted into FinalAllocation table!");
    });
  });
});
