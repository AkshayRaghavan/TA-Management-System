use se;
-- Create the table, this is aims user details table
create table IF NOT EXISTS UserDetails(uname varchar(100),pwd varchar(100),type varchar(100),submitted boolean); 
